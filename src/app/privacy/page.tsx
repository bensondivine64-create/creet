  ...
  return (
    <main className="min-h-screen bg-paper">
      <div className="max-w-2xl mx-auto px-5 py-12">
        <h1 className="font-display text-2xl font-bold text-fg mb-2">Privacy Policy</h1>
        <p className="text-sm text-fg/40 mb-8">Last updated: August 2026</p>

        <div className="space-y-6 text-sm text-fg/70 leading-relaxed">
          <section>
            <h2 className="font-semibold text-fg mb-1">1. What we collect</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-fg mb-1">2. How we use it</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-fg mb-1">3. Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-fg mb-1">4. Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-fg mb-1">5. Your choices</h2>
            <p>
