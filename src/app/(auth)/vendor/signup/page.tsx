...
export default function VendorSignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await signup({ ...form, role: 'vendor', recaptcha_token: captchaToken });
  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <h1 className="font-display text-2xl font-bold text-fg mb-1.5">Open a store on CREET</h1>
      <p className="text-sm text-muted mb-6">Sell physical products to real buyers.</p>
