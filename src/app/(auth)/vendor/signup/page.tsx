...
export default function VendorSignupPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-xl font-bold text-ink mb-1">Open a store on CREET</h1>
      <p className="text-sm text-ink/50 mb-6">Sell physical products to real buyers.</p>
