...
export default function BuyerSignupPage() {
  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <h1 className="font-display text-2xl font-bold text-fg mb-1.5">Create your buyer account</h1>
      <p className="text-sm text-muted mb-6">Browse, hire, and buy on CREET.</p>
