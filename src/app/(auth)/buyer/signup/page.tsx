...
export default function BuyerSignupPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-xl font-bold text-fg mb-1">Create your buyer account</h1>
      <p className="text-sm text-fg/50 mb-6">Browse, hire, and buy on CREET.</p>
