    ...
    <main className="min-h-screen bg-paper">
      <div className="max-w-2xl mx-auto px-5 py-12">
        ...
        <div className="space-y-6 text-sm text-fg/70 leading-relaxed">
          <section>
            <h2 className="font-semibold text-fg mb-1">1. Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-fg mb-1">2. Your responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-fg mb-1">3. Messaging</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-fg mb-1">4. Moderation</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-fg mb-1">5. Changes</h2>
            <p>
