...
export default function AccountSettingsPage() {
  ...
  const inputClass = 'w-full rounded-lg border border-line bg-mist px-3.5 py-3 text-sm text-fg placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-blue/40';
        ...
        <div className="pt-8 border-t border-line/60">
          ...
          {!showDeleteConfirm ? (
            <button
              ...
              className="w-full border border-red-500/30 text-red-400 text-sm font-semibold rounded-lg py-3"
            >
              Delete my account
            </button>
          ) : (
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 border border-line text-fg text-sm font-semibold rounded-lg py-3"
                >
                  Cancel
                </button>
                <button
